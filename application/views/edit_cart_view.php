...
<div class="judul-2 col-md-offset-2 col-sm-offset-2 col-xs-offset-2 row" data-example-id="carousel-with-captions">
    ...
    <h3 style="padding-left: 5%">Edit Cart Barang <span class="glyphicon glyphicon-cog" aria-hidden="true"></span></h3>

    <?php foreach ($cart->result() as $c): ?>

        <?php echo form_open('customer/edit_cart/'.$c->id_barang); ?>
    ...
    <div class="col-md-0 col-md-offset-1">
        <img height="100px" width="150px" src="<?= base_url().$c->gambar_barang ?>"</img>
    </div>
    <div class="col-md-2 col-md-offset-1">
        <?php echo form_label('Nama Barang :'); ?>
    </div>
    <div class="col-md-0 col-md-offset-1">
        <?php echo form_label(set_value('nama_barang', $c->nama_barang))?>
    </div>
    <div class="col-md-2 col-md-offset-1">
        <?php echo form_label('Harga :'); ?>
    </div>
    <div class="col-md-0 col-md-offset-1">
        <?php echo form_label(set_value('harga_jual', "Rp " . number_format($c->harga_belanja,2,",",".")))?>
    </div>
    <div class="col-md-2 col-md-offset-1">
        <?php echo form_label('Jumlah :'); ?>
    </div>
    <div class="col-md-0 col-md-offset-1">
        <?php echo form_label(set_value('jumlah', number_format($c->jumlah_belanja,0,",",".")))?>
    </div>
    <div class="col-md-2 col-md-offset-1">
        <?php echo form_label('Merk :'); ?>
    </div>
    <div class="col-md-0 col-md-offset-1">
        <?php echo form_label(set_value('merk_barang', $c->merk_barang))?>
    </div>
    <div class="col-md-2 col-md-offset-1">
        <?php echo form_label('Berat :'); ?>
    </div>
    <div class="col-md-0 col-md-offset-1">
        <?php echo form_label(set_value('satuan_berat',  number_format($c->nilai_berat,0,",",".") . " " . $c->satuan_berat))?>
    </div>
    <div class="col-md-11 col-md-offset-1">
        <?php echo form_label('Jumlah Belanja Baru :'); ?>
    </div>
    ...
    <div class="col-md-2 col-md-offset-1">
        <?php echo form_input(array(
            ...
            'value' => set_value('jumlah_belanja', $c->jumlah_belanja)
        )); ?>
    </div>
        <?php echo form_error('jumlah_belanja'); ?>
