...
<div class="judul-2 col-md-offset-2 col-sm-offset-2 col-xs-offset-2 row" data-example-id="carousel-with-captions">
    ...
    <h3 style="padding-left: 5%"><a href="<?= base_url() ?>index.php/customer/add_refund">ADD <span
        ...
        <?php if ($refund->result()) { ?>
            ...
            <?php foreach ($refund->result() as $r): ?>
                ...
                <tr
                    ...
                    <td><a href="<?= base_url() ?>index.php/customer/view_data_refund/<?= $r->id_penjualan ?>/<?= $r->id_refund_cus ?>"
