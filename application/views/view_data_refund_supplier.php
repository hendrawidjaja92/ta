...
<?php echo form_open('supplier/manage_refund/'); ?>
...
<?php foreach ($pembelian->result() as $p): ?>
    <?php foreach ($refund->result() as $r): ?>
        ...
        <div class="col-md-0 col-md-offset-1">
            <?php echo form_label(set_value('total_beli', "Rp " . number_format($r->total_refund, 2, ",", "."))) ?>
        </div>
        <div class="col-md-2 col-md-offset-1">
...
<br>
    ...
    <table class="table table-hover">
        ...
        <?php foreach ($detail->result() as $d): ?>
            ...
            <tr
                class="<?= ($d->status_refund == 1) ? "alert-success" : "" ?> <?= ($d->status_refund == 2) ? "alert-danger" : "" ?>">
                <td><?= $i ?></td>

                <td align="center"><img height="100px" width="150px" src="<?= base_url().$d->gambar_barang ?>" /></td>
                <td><?= $d->nama_barang ?></td>
                <td align="right"><?= number_format($d->jumlah_refund_detail, 0, ",", ".") ?></td>

                <td align="right"><?= "Rp " . number_format($d->harga_refund_detail, 2, ",", ".") ?></td>
                ...
                <td><a href="<?= base_url() ?>index.php/supplier/edit_refund/<?= $d->id_barang ?>/<?= $d->id_refund ?>"
