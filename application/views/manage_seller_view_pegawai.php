...
<div class="judul-2 col-md-offset-0 col-sm-offset-2 col-xs-offset-2 col-md-10 row"
    ...
    <h3 style="padding-left: 5%"><a href="<?= base_url() ?>index.php/pegawai/add_seller">ADD <span
    ...
    <table class="table table-hover">
        ...
        <?php if ($seller->result()) { ?>

            <?php foreach ($seller->result() as $s): ?>
                ...
                <tr
                    ...
                    <td><a href="<?= base_url() ?>index.php/pegawai/view_seller/<?= $s->id_user ?>"
                           class="glyphicon glyphicon-user" aria-hidden="true"> VIEW</a></td>
                    <td><a href="<?= base_url() ?>index.php/pegawai/edit_seller/<?= $s->id_user ?>"
...
<script type="text/javascript">
    ...
    function confDelete(id) {
        ...
        if (confimation) {
            window.location = "<?= base_url() ?>index.php/pegawai/delete_seller/" + id;
        }
    }
